"use strict";
let persName = "Abdullah";
let quote = "ALLAH is one";
...
console.log("Q4-------------");
let qot = "Always obey your elders.";
console.log(`Umar said that,"${qot}"`);
console.log("Q45------------");
let famPerson = "Neuton";
let quot = "Every action has a reaction";
console.log(`${famPerson} said that,"${quot}"`);
console.log("Q6-------------");
let pName = "\tUsman\n";
console.log(pName);
let trimNam = pName.trim();
console.log(trimNam);
console.log("Q-------------Q7+8");
...
console.log("Q13-------------");
let vehicl = ["Motorcycle", "car", "jeep"];
...
for (let frnd in friend) {
    console.log("My dear " + friend[frnd] + "!" + " I invite you in my birthday party.");
}
console.log("Q16-------------");
let bigTable = friend.push("ali", "muhsin", "hasnain");
console.log(friend);
for (let frd in friend) {
    console.log("My dear " + friend[frd] + "!" + " I invite you in my big birthday party.");
}
...
console.log(friend);
for (let Frnd in friend) {
    console.log("My dear " + friend[Frnd] + "!" + " I invite you in my birthday new party.");
}
console.log("Q17-------------");
...
console.log("Q25-------------");
let alianColour = "green";
console.log(alianColour == "green" ? "you earned five point" : "choose the colour");
console.log("Q26-------------");
let alianColour2 = "yellow";
...
for (let user in userArr) {
    if (userArr[user] == "Admin") {
        ...
        console.log(`Hello ${userArr[user]}, Well come to login again.`);
}
console.log("Q31------------");
for (let user in userArr) {
...
console.log("Q37-------------");
let make_Shirt1 = (size = "large", text = "I like TypeScript") => {
    console.log(`The size is ${size} The text is "${text}"`);
};
make_Shirt1();
...
console.log("Q39-------------");
let describe_City1 = (city = "karachi", country = "Pakistan") => {
